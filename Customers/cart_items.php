        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="alert alert-default" style="color:white;background-color:#008CBA">
                    <center><h3> <span class="fa fa-cart-plus"></span> Daftar Keranjang Belanja</h3></center>
                </div>
                <br />
                    ...
                    <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-block btn-danger" href="?delete_id=<?php echo oci_result($stid,'ORDER_ID'); ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item?')"><span class='glyphicon glyphicon-trash'></span> Remove Item</a>
                                </td>
                            </tr>
                            <?php
                                }
