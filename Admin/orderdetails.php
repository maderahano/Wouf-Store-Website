    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
		    <div class="alert alert-danger">
                <center> <h3><strong>Detail Managemen Pesanan</strong> </h3></center>
			</div>
			<br />
			<div class="table-responsive">
                <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			        ...
			        <?php
                        ...
                        $sql = "SELECT order_id, order_date,users.user_firstname, users.user_lastname, order_name, order_price, order_quantity, order_total FROM orderdetails, users WHERE orderdetails.user_id=users.user_id ORDER BY order_date DESC";
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger" href="?delete_id=<?php echo oci_result($stid,'ORDER_ID'); ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item ordered?')">
                            <span class='glyphicon glyphicon-trash'></span>Hapus Pesanan Barang</a>
                        </td>
                    </tr>
                    <?php
		                    }
