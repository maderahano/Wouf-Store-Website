                ...
                <div class="clearfix"></div>
                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="alert alert-info">
                            <center> <h3><strong>Update Barang</strong> </h3></center>
                        </div>
                        <?php
                        ...
                        <table class="table table-bordered table-responsive">
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="item_name" value="<?php echo oci_result($stid,'ITEM_NAME'); ?>" required /></td>
                            </tr>
                            <tr>
                                <td><label class="control-label">Harga.</label></td>
                                <td><input id="inputprice" class="form-control" type="text" name="item_price" value="<?php echo oci_result($stid,'ITEM_PRICE'); ?>" required /></td>
                            </tr>
                            <tr>
                                <td><label class="control-label">Gambar.</label></td>
                                <td>
                                    <p><img class="img img-thumbnail" src="item_images/<?php echo oci_result($stid,'ITEM_IMAGE'); ?>" height="150" width="150" /></p>
